 ...
 */
public class DrawLinePasscon extends View {
     ...
     */
    private Rect[] circles = new Rect[20];
     ...
     */
    public DrawLinePasscon(Context context) {
        super(context);
        init(context, null);
    }
     ...
     */
    public DrawLinePasscon(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
     ...
     */
    public DrawLinePasscon(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public DrawLinePasscon(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        centerTopX = leftX + (rightX - leftX) / 4;
        centerTopY = topY + (bottomY - topY) / 4;

        centerX = leftX + (rightX - leftX) / 2;
        centerY = topY + (bottomY - topY) / 2;

        centerBottomX = rightX + (leftX - rightX) / 4;
        centerBottomY = bottomY + (topY - bottomY) / 4;
...
//        circles[1] = new Rect(centerTopX - radius, topY, centerTopX + radius, topY + diameter);
//        circles[2] = new Rect(rightX - diameter, topY, rightX, topY + diameter);
//        circles[3] = new Rect(leftX, centerTopY - radius, leftX + diameter, centerTopY + radius);
//        circles[4] = new Rect(centerTopX - radius, centerTopY - radius, centerTopX + radius, centerTopY + radius);
//        circles[5] = new Rect(rightX - diameter, centerTopY - radius, rightX, centerTopY + radius);
//        circles[6] = new Rect(leftX, bottomY - diameter, leftX + diameter, bottomY);
//        circles[7] = new Rect(centerTopX - radius, bottomY - diameter, centerTopX + radius, bottomY);
//        circles[8] = new Rect(rightX - diameter, bottomY - diameter, rightX, bottomY);
//        circles[9] = new Rect(leftX, bottomY - diameter, rightX, bottomY);
//    }
    private void setupCircles() {
        circles[0] = new Rect(leftX, topY, leftX + diameter, topY + diameter);
        circles[1] = new Rect(centerTopX - radius, topY, centerTopX + radius, topY + diameter);
        circles[2] = new Rect(centerX - radius, topY, centerX + radius, topY + diameter);
        circles[3] = new Rect(centerBottomX - radius, topY, centerBottomX + radius, topY + diameter);
        circles[4] = new Rect(rightX - diameter, topY, rightX, topY + diameter);
        circles[5] = new Rect(leftX, centerTopY - radius, leftX + diameter, centerTopY + radius);
        circles[6] = new Rect(centerTopX - radius, centerTopY - radius, centerTopX + radius, centerTopY + radius);
        circles[7] = new Rect(centerX - radius, centerTopY - radius, centerX + radius, centerTopY + radius);
        circles[8] = new Rect(centerBottomX - radius, centerTopY - radius, centerBottomX + radius, centerTopY + radius);
        circles[9] = new Rect(rightX - diameter, centerTopY - radius, rightX, centerTopY + radius);
        circles[10] = new Rect(leftX, centerBottomY - radius, leftX + diameter, centerBottomY + radius);
        circles[12] = new Rect(leftX, bottomY - diameter, leftX + diameter, bottomY);
        circles[13] = new Rect(centerTopX - radius, bottomY - diameter, centerTopX + radius, bottomY);
        circles[14] = new Rect(rightX - diameter, bottomY - diameter, rightX, bottomY);
        circles[15] = new Rect(leftX, bottomY - diameter, rightX, bottomY);
    }
